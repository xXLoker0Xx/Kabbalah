...
template = PromptTemplate(
    ...
    template="""
Actúa como un creador de títulos impactantes y emocionales para vídeos distópicos cortos en redes sociales.

Dado el siguiente concepto o escena, genera un título breve (de 3 a 8 palabras), sin comillas ni signos de puntuación, directo, evocador y visualmente potente.
